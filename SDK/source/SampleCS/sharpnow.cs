...
namespace sharpnow
{
    ...
    unsafe public class SDK
    {
        ...
        [DllImport("../../../lib/sharpnow.dll", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("../../../lib/sharpnow.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr GetFrameInfo();                             //! 得到帧状态        
        [DllImport("../../../lib/sharpnow.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr GetFinger(int finger);                      //! 得到指定手指状态       
        [DllImport("../../../lib/sharpnow.dll")]
        public static extern IntPtr GetFingerFocus();                           //! 得到手指焦点状态       
        [DllImport("../../../lib/sharpnow.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr GetHand(int hand);                          //! 得到指定手掌状态
        [DllImport("../../../lib/sharpnow.dll")]
        public static extern IntPtr GetHandFocus();                             //! 得到手掌焦点状态
    }
    ...
    unsafe public struct Finger
    {
        ...
        public bool contact;                //!< 是否接触
        public bool poke;                   //!< 是否有指戳动作
        public bool tap;                //!< 是否有向下点击动作
    ...
    unsafe public struct Hand
    {
        ...
        public int gesture_counter;     //!< 姿态计数器
